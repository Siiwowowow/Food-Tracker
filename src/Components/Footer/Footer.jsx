...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer border-t-1 sm:footer-horizontal footer-center bg-base-300 text-base-content p-4">
                <aside>
                    <p>Copyright © {new Date().getFullYear()} - All right reserved by Rafsan Ahmed</p>
                </aside>
            </footer>
        </div>
    );
