const NewsLetter = () => {
    return (
        <div className="flex bg-gray-100 md:flex-row flex-col border border-gray-500/30 rounded-lg items-start md:items-center justify-between gap-5 text-sm max-w-5xl p-8">
