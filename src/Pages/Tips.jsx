...
const Tips = () => {
    return (
     ...
     data-aos-duration="2000" className="w-full sm:w-[90%] md:w-[47%] lg:w-[45%] bg-green-50 rounded-lg p-6 border border-green-100 shadow-sm">
                ...
                <div data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000" className="w-full sm:w-[90%] md:w-[47%] lg:w-[45%] bg-blue-50 rounded-lg p-6 border border-blue-100 shadow-sm">
                    <div className="flex items-center gap-2 mb-4">
